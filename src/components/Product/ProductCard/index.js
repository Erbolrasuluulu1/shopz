    ...
    return (
        <div className="w-[500px] flex  flex-col items-center ">
            <Link to={`/details/${el.id}`}>
                <img className="p-9 w-[300px] " src={el.image} alt="product image"/>
            </Link>
            <div className="px-5 pb-5">
                <h2 className="text-1xl font-semibold tracking-tight text-gray-900 dark:text-white">{el.title}</h2>
                <a href="#">
                    <h5 className="text-1xl font-semibold tracking-tight text-gray-900 dark:text-white">{el.description}</h5>
                </a>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-2xl font-bold text-gray-900 dark:text-white">{el.price} $</span>
              <div>
